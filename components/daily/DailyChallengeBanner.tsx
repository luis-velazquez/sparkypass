...
import { Calendar, Flame, CheckCircle2, ChevronRight, Trophy } from "lucide-react";
        ...
        <Link href="/daily">
          <div className="relative overflow-hidden rounded-xl border border-emerald/30 dark:border-sparky-green/30 bg-emerald/5 dark:bg-sparky-green/5 p-4 group hover:border-emerald/50 dark:hover:border-sparky-green/50 hover:shadow-[0_0_20px_rgba(16,185,129,0.08)] dark:hover:shadow-[0_0_20px_rgba(163,255,0,0.08)] transition-all cursor-pointer pressable">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-emerald/20 dark:bg-sparky-green/20 dark:shadow-[0_0_12px_rgba(163,255,0,0.35)] flex items-center justify-center flex-shrink-0">
      ...
      <Link href="/daily">
        <div className="relative overflow-hidden rounded-xl border border-purple/30 dark:border-purple/25 bg-gradient-to-r from-purple/10 via-purple/5 to-amber/10 dark:from-purple/10 dark:via-purple/5 dark:to-amber/10 p-5 group hover:border-purple/50 hover:shadow-[0_0_24px_rgba(139,92,246,0.12)] transition-all cursor-pointer pressable">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-full bg-purple/20 dark:shadow-[0_0_15px_rgba(139,92,246,0.35)] flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-all duration-300">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-3">
                ...
                <Button
                  size="sm"
                  className="bg-purple hover:bg-purple/90 text-white flex-shrink-0 hidden md:inline-flex"
                  tabIndex={-1}
                >
                  Start Challenge
                </Button>
              ...
              <Button
                size="sm"
                className="bg-purple hover:bg-purple/90 text-white w-full mt-3 md:hidden"
                tabIndex={-1}
              >
                Start Challenge
              </Button>
